...
public class CustomerService {
    public static void Run()
    {
        ...
        // Test 1
        // Scenario: Can I add four customers and then serve the customer?
        // Expected Result: This should display the customers that were added
        ...
        // Test 2
        // Scenario: Can I add a customer when the queue is full?
        // Expected Result: This should display a message indicating the queue is full
        Console.WriteLine("Test 2");
        CustomerService service2 = new CustomerService(4);
       service.AddNewCustomer();
        service.AddNewCustomer();
        service.AddNewCustomer();
        service.AddNewCustomer();
        ...
        Console.WriteLine("================="); 
        // Test 5
        // Scenario: Can I add multiple customers and then serve them in the right order?
        ...
        Console.WriteLine($"Max Size: {service._maxSize}");
        // Defect(s) Found: This found that I need to default the max size to 10 if the value is invalid
        Console.WriteLine("================="); 
